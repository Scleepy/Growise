            ...
            <div class="flex w-8/12 justify-between">
                ...
                <div class="w-7/12">
                    ...
                    <p class="text-justify text-[15px] pt-5">
                        ...
                        <br><br>
                        We're unwavering in our dedication to provide you with an array of sustainable options. From eco-conscious products to services that reduce your carbon footprint, our commitment to environmental responsibility is at the heart of everything we do.</p>                
                </div>  
            </div>
        </div>

        <div class="flex mx-auto bg-accent w-full justify-center items-center max-w-screen-2xl min-h-[calc(100vh-15rem)]">
            <div class="w-3/12">
