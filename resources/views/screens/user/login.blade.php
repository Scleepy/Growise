            ...
            <form method="POST" action="/users/authenticate" class="w-full flex flex-col items-center justify-between">
                ...
                <div class="w-full">
                    <input type="text" name="email" placeholder="Email"
                        class="focus:outline-none border-2 rounded-none border-black h-10 bg-transparent input input-bordered w-full"
                        value="{{ old('email') }}" />
                ...
                <div class="w-full">
                    <input type="password" name="pass" placeholder="Password"
                        class="focus:outline-none border-2 mt-5 rounded-none border-black h-10 bg-transparent input input-bordered w-full"
                        value="{{ old('pass') }}" />
                ...
                <div class="w-full pt-5">
                    <button
                        class="btn btn-secondary font-normal normal-case w-full text-neutral text-lg rounded-none">Login</button>
                    <p class="pt-3 text-center text-secondary text-sm">Don't have any account? <a href="/signup"
