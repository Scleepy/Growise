    ...
    <div class="min-h-screen flex flex-row px-8 py-16">
            ...
            <div class="w-full flex flex-col gap-2 font-josefinsans">
                ...
                <form class="w-80 flex flex-col justify-start gap-4" action="">
                    <div class="flex flex-col">
                        ...
                        <input type="date" name="minTransactionDate" placeholder=""
                    ...
                    <div class="flex flex-col">
                        ...
                        <input type="date" name="maxTransactionDate" placeholder=""
                            class="py-1 px-4 bg-white border-slate-950 border-2 outline-none font-normal">
                        <style>
                            input[type="date"]::-webkit-calendar-picker-indicator {
                                filter: invert(100%);
        ...
        <div class="w-full h-full flex flex-col overflow-y-auto max-h-[75vh] no-scrollbar">
            @forelse ($transactions as $transaction)
                <x-admin-transaction-card :transaction="$transaction" />
            @empty
                <p class="text-xl text-red-500">No transactions found.</p>
            @endforelse
        </div>
    </div>
@endsection
