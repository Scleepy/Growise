...
@section('content')
    <div class="min-h-[75vh] px-24 py-10 flex flex-col items-center justify-center">
        ...
        <!-- Login Form -->
        <form method="GET" class="flex flex-col justify-center items-center gap-4 font-josefinsans"
            ...
            <button type="submit"
                class="btn btn-secondary w-[325px] font-normal normal-case px-14 text-lg rounded-none">Login</button>
        </form>
    </div>
@endsection
