    ...
    <div class="scroll-smooth">
            ...
            <div class="hero-content text-center text-neutral-content">
                <div class="max-w-lg">
                    ...
                    <a href="{{ route('products') }}"
                        class="btn btn-secondary font-normal normal-case px-14 text-lg rounded-none">Explore Collection</a>
                </div>
            </div>
        </div>
        ...
        <div class="flex mx-auto flex-col w-full justify-center items-center max-w-screen-2xl min-h-[calc(100vh-15rem)]">
            ...
            <div class="carousel space-x-6 pt-10">
                <a href="{{ route('getProductsBySlug', ['slug' => 'reusable-items']) }}">
                    <div class="carousel-item flex-col">
                        <img src="{{ asset('image/home/catalogue_reusable_item.png') }}" alt="Reusable Items"
                            width="164" />
                        <p class="text-center">Reusable Items</p>
                    </div>
                </a>
                <a href="{{ route('getProductsBySlug', ['slug' => 'home-goods']) }}">
                    <div class="carousel-item flex-col">
                        <img src="{{ asset('image/home/catalogue_home_goods.png') }}" alt="Home Goods" width="164" />
                        <p class="text-center">Home Goods</p>
                    </div>
                </a>
                <a href="{{ route('getProductsBySlug', ['slug' => 'personal-care']) }}">
                    <div class="carousel-item flex-col">
                        <img src="{{ asset('image/home/catalogue_personal_care.png') }}" alt="Personal Care"
                            width="164" />
                        <p class="text-center">Personal Care</p>
                    </div>
                </a>
                <a href="{{ route('getProductsBySlug', ['slug' => 'fashion']) }}">
                    <div class="carousel-item flex-col">
                        <img src="{{ asset('image/home/catalogue_fashion.png') }}" alt="Fashion" width="164" />
                        <p class="text-center">Fashion</p>
                    </div>
                </a>
                <a href="{{ route('getProductsBySlug', ['slug' => 'energy-solutions']) }}">
                    <div class="carousel-item flex-col">
                        <img src="{{ asset('image/home/catalogue_energy_solutions.png') }}" alt="Energy Solutions"
                            width="164" />
                        <p class="text-center">Energy Solutions</p>
                    </div>
                </a>
                <a href="{{ route('getProductsBySlug', ['slug' => 'up-recycled-goods']) }}">
                    <div class="carousel-item flex-col">
                        <img src="{{ asset('image/home/catalogue_uprecycled_goods.png') }}" alt="Up/Recycled Goods"
                            width="164" />
                        <p class="text-center">Up/Recycled Goods</p>
                    </div>
                </a>
                <a href="{{ route('getProductsBySlug', ['slug' => 'food']) }}">
                    <div class="carousel-item flex-col">
        ...
        <div id="about-us" class="flex mx-auto w-full justify-center items-center max-w-screen-2xl min-h-screen">
            <div class="flex w-8/12 justify-between">
                <div class="w-6/12">
                    <img src="{{ asset('image/home/farmer.png') }}" alt="Farmer" width="400"
                        class="rounded-tl-[74px] relative z-10" />
                ...
                <div class="w-7/12">
                    ...
                    <p class="text-justify text-[15px] pt-5">
                        At Growise, we've been committed to shaping a more sustainable future since 2023. Our platform is
                        not just about buying and selling; it's a thriving ecosystem where you can explore a diverse
                        selection of eco-friendly goods and services that align with your values.
                        <br><br>
                        Our journey started with the belief that every small action contributes to a better world. We
                        understood the importance of making sustainable choices in our everyday lives. Since our
                        establishment, we've been on a mission to make those choices more accessible to everyone.
                        <br><br>
                        We're unwavering in our dedication to provide you with an array of sustainable options. From
                        eco-conscious products to services that reduce your carbon footprint, our commitment to
        ...
        <div class="flex mx-auto bg-accent w-full justify-center items-center min-h-[calc(100vh-15rem)]">
            <div class="w-3/12">
                ...
                <p class="text-neutral w-11/12 text-[15px] pt-5 pb-5 text-justify">
                    Discover our top-rated, eco-friendly favorites in Our Best Sellers collection - products that lead the
                    way in sustainability and quality, making a positive impact with every purchase.
                    <br><br>
                    From eco-conscious essentials to innovative green solutions, Our Best Sellers embody the essence of
                    responsible living. Join the movement towards a more sustainable future today.
                </p>
                <button class="btn btn-secondary font-normal normal-case px-14 text-lg rounded-none">Explore
                    Collection</button>
            </div>

            <div class="w-8/12 carousel carousel-center justify-evenly p-4 space-x-10">
                <x-best-seller-card :image="'image/home/best_seller_1.jpg'" :category="'Reusable Items'" :title="'Epic Totebag'" :originalPrice="'Rp. 75,000'"
                    :discountedPrice="'Rp. 50,000'" :url="'catalogue'" />
                <x-best-seller-card :image="'image/home/best_seller_2.jpg'" :category="'Reusable Items'" :title="'Mario x Growise Bag'" :originalPrice="'Rp. 750,000'"
                    :discountedPrice="'Rp. 550,000'" :url="'catalogue'" />
                <x-best-seller-card :image="'image/home/best_seller_3.png'" :category="'Personal Care'" :title="'Brin Toothbrush'" :originalPrice="'Rp. 55,000'"
                    :discountedPrice="'Rp. 24,750'" :url="'catalogue'" />
            </div>
        </div>
