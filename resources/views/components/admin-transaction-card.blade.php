...
<a href="#" class="w-full h-fit flex flex-row justify-between items-center p-4 border border-black bg-primary font-josefinsans hover:bg-primaryDark transition duration-400 cursor-pointer">
